...
internal object DataGenerator {
     ...
     */
    fun createRandomName(namePrefix: String): String {
    ...
    fun createTempLocalFile(tempFileNamePrefix: String?, tempFileNameSuffix: String?, bytesToWrite: Int): File? {
        var bytesToWrite = bytesToWrite
        var tempFile: File? = null
        var tempFileOutputStream: FileOutputStream? = null
        try { // Create the temporary file
            ...
            while (bytesToWrite > 0) {
                ...
                tempFileOutputStream.write(randomBytes, 0, if (bytesToWrite > 4096) 4096 else bytesToWrite)
                bytesToWrite -= 4096
            }
        } finally { // Close the file output stream writer
